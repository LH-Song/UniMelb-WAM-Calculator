...
const resources: Array<Resource> = [
  {
    href: '/weighted-average-mark',
    name: 'Weighted Average Mark (WAM)',
    description:
  ...
  {
    href: '/academic-transcripts-and-statements',
    name: 'Academic transcripts and statements',
    description:
  ...
  {
    href: '/about-my-equals',
    name: 'About my eQuals',
    description:
  ...
  {
    href: '/failing-a-subject',
    name: 'Failing a subject',
    description:
